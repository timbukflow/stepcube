...
<body>
    ...
    <section class="maincontainer">
      <article class="start">
        ...
        <p>An der Löwenstrasse in Romanshorn entsteht ein attraktiver und moderner Lebensraum für Menschen mit Liebe zum Bodensee. Die Überbauung «Stepcube» bietet 20 Mietwohnungen, 300 Quadratmeter Büro- und Gewerbefläche sowie 17 Parkplätze zu attraktiven Preisen in zentraler Lage zwischen Bahnhof, Hafen und See. Ob für Singles, Seefahrer, Selbstständige oder Senioren – die modern ausgestatteten Wohnungen mit ihren offenen Grundrissen erfüllen jegliche Ansprüche an ein aktives und mobiles Leben in Ufernähe.
        </p>
      ...
      <article class="wohnen" id="wohnen">
        ...
        <img class="wohnenimg nightimg" src="img/stepcube-wohnen-in-romanshorn-start-day.jpg" alt="..." width="100%" height="auto">
        <img class="wohnenimg dayimg" src="img/stepcube-wohnen-in-romanshorn-start.jpg" alt="..." width="100%" height="auto">
        <h1 class="header">Für Singles und Seefahrerinnen</h1>
        ...
        <div class="wcontainer">
          <img class="wohnenimgtwo" src="img/stepcube-wohnen-in-romanshorn-start.jpg" alt="..." width="100%" height="auto">
          <img class="wohnenimgthree" src="img/stepcube-wohnen-in-romanshorn-start.jpg" alt="..." width="100%" height="auto">
          <div class="inputs ">
            <img src="img/stepcube-cross.svg" alt="stepcube-cross" width="30" height="30">
            <h3>25 min<br>nach St.Gallen</h3>
          </div>
        </div>
        <h1 class="header two">Für Sonnenanbeter und frisch Verliebte</h1>
